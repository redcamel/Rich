  ...
  return new Promise(function (resolve, reject) {
    Promise.all([].concat(urlList).map(function (src) {
      ...
      if (failRes) {
        ...
        Promise.all(response.map(function (res) {
...
var Rich = function (_) {
  ...
  tempRich.addMethod('getJS', getJS); // class
...
(function (undefined$1) {
  ...
  function RequireObjectCoercible(e) {
    if (null === e || e === undefined$1) throw TypeError();
    return e;
  }
  ...
  function GetMethod(e, n) {
    var r = GetV(e, n);
    if (null === r || r === undefined$1) return undefined$1;
  ...
  function IsRegExp(e) {
    ...
    var t = "Symbol" in this && "match" in this.Symbol ? Get(e, this.Symbol.match) : undefined$1;
    if (t !== undefined$1) return ToBoolean(t);
  ...
  function ToPrimitive(e) {
    ...
    if ("object" === Type(e)) {
      ...
      var r = "function" == typeof this.Symbol && "symbol" == _typeof(this.Symbol.toPrimitive) ? GetMethod(e, this.Symbol.toPrimitive) : undefined$1;
  ...
  CreateMethodProperty(Array.prototype, "copyWithin", function t(r, e) {
    ...
    var a = arguments[2];
    if (null === this || this === undefined$1) throw new TypeError("Cannot call method on " + this);
    var n = Object(this),
  ...
  CreateMethodProperty(Array.prototype, "fill", function t(e) {
    for (var r = arguments[1], n = arguments[2], o = ToObject(this), a = ToLength(Get(o, "length")), h = ToInteger(r), i = h < 0 ? Math.max(a + h, 0) : Math.min(h, a), g = n === undefined$1 ? a : ToInteger(n), M = g < 0 ? Math.max(a + g, 0) : Math.min(g, a); i < M;) {
      o[ToString(i)] = e, i += 1;
    }
  ...
  CreateMethodProperty(Array.prototype, "find", function e(r) {
    ...
    for (var o = arguments.length > 1 ? arguments[1] : undefined$1, a = 0; a < n;) {
      var i = ToString(a),
          f = Get(t, i);
  ...
  CreateMethodProperty(Object, "assign", function e(r, t) {
    ...
    for (a = 0; a < p.length; a++) {
      ...
      for (b === undefined$1 || null === b ? c = [] : (l = ToObject(b), c = Object.keys(l)), o = 0; o < c.length; o++) {
        var i,
            u = c[o];

        try {
          var y = Object.getOwnPropertyDescriptor(l, u);
          i = y !== undefined$1 && !0 === y.enumerable;
        } catch (O) {
  ...
  CreateMethodProperty(String.prototype, "endsWith", function e(t) {
    ...
    var r = arguments.length > 1 ? arguments[1] : undefined$1,
  ...
  CreateMethodProperty(String.prototype, "padEnd", function e(r) {
    ...
    var t = arguments.length > 1 ? arguments[1] : undefined$1,
        ...
        u = i.length;
    if (o <= u) return i;
    if (t === undefined$1) var d = " ";else var d = ToString(t);
    if ("" === d) return i;

    for (var f = o - u, a = "", g = 0; g < f; g++) {
      a += d;
    }
  ...
  CreateMethodProperty(String.prototype, "padStart", function e(r) {
    ...
    var t = arguments.length > 1 ? arguments[1] : undefined$1,
        ...
        u = i.length;
    if (o <= u) return i;
    if (t === undefined$1) var a = " ";else var a = ToString(t);
    if ("" === a) return i;

    for (var f = o - u, d = "", g = 0; g < f; g++) {
      d += a;
    }
  ...
  CreateMethodProperty(Object, "getOwnPropertyDescriptors", function e(r) {
    for (var t = ToObject(r), o = Reflect.ownKeys(t), n = {}, c = o.length, a = 0; a < c; a++) {
      ...
      y !== undefined$1 && CreateDataProperty(n, p, y);
    }
  ...
  !function (e) {
    ...
    var r = function () {
      ...
      var t = arguments.length > 0 ? arguments[0] : undefined$1;
      if (null === t || t === undefined$1) return e;
      var o = e.set;
    ...
    Object.defineProperty(a, "prototype", {
      ...
      for (var t = e._keys, a = 0; a < t.length; a++) {
        e._keys[a] = o, e._values[a] = o;
      }

      return this._size = 0, r || (this.size = this._size), undefined$1;
      ...
      get: function get() {
        ...
        for (var t = e._keys, r = 0, a = 0; a < t.length; a++) {
          e._keys[a] !== o && (r += 1);
        }
    ...
    Object.defineProperty(n, "isMapIterator", {
      ...
      if (t === undefined$1) return CreateIterResultObject(undefined$1, !0);
      ...
      return e["[[Map]]"] = undefined$1, CreateIterResultObject(undefined$1, !0);
  ...
  !function (e) {
    ...
    Object.defineProperty(i, "isSetIterator", {
      ...
      return e["[[IteratedSet]]"] = undefined$1, CreateIterResultObject(undefined$1, !0);
  ...
  !function () {
    ...
    CreateMethodProperty(Array, "from", function o(t) {
      var o = this,
          a = arguments.length > 1 ? arguments[1] : undefined$1;
      if (a === undefined$1) var n = !1;else {
        if (!1 === IsCallable(a)) throw new TypeError(Object.prototype.toString.call(a) + " is not a function.");
        var i = arguments.length > 2 ? arguments[2] : undefined$1;
        if (i !== undefined$1) var l = i;else l = undefined$1;
        n = !0;
      }
  ...
  var Iterator = function () {
    ...
    return Object.defineProperties(_.prototype, Object.assign({
      ...
      _next: {
        value: function value() {
          var e;
          if (this.__list__) return this.__redo__ && (e = this.__redo__.shift()) !== undefined$1 ? e : this.__nextIndex__ < this.__list__.length ? this.__nextIndex__++ : void this._unBind();
        },
        configurable: !0,
        enumerable: !1,
        writable: !0
  ...
  !function (e) {
    var t = Symbol("undef"),
      ...
      var e = OrdinaryCreateFromConstructor(this, a.prototype, {
        ...
        _es6WeakMap: !0
          ...
          t = arguments.length > 0 ? arguments[0] : undefined$1;
      if (null === t || t === undefined$1) return e;
      var r = Get(e, "set");
    ...
    Object.defineProperty(r, "prototype", {
      ...
      var o = r._keys;
      if ("object" !== Type(e)) return undefined$1;
...
}).call('object' === (typeof window === "undefined" ? "undefined" : _typeof(window)) && window || 'object' === (typeof self === "undefined" ? "undefined" : _typeof(self)) && self || 'object' === (typeof global === "undefined" ? "undefined" : _typeof(global)) && global || {}); // export default result
