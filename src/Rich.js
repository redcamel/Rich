        ...
        init: (...urls) => {
            return new Promise((resolve, reject) => {
                let tick = time => {
                    ...
                    console.log(time);
                    if (urls) getJS(...urls).then(v => resolve(tempRich));
