Rich.init(
    ...
    describe('Test Rich.defineProperty( target, keyName, type, option, isCustomType = false )', function () {
        describe('Test - target', function () {
            describe('Object 확장일 경우 테스트 ( function(){}, class{}, {}, [] ) => 전부 성공해야함', function () {
            ...
            describe('Object 확장이 아닐경우 테스트 => 전부 실패해야함', function () {
                TEST_HELPER.makeTestByList(
        ...
        describe('Test - keyName', function () {
            describe('문자열이외 입력시 에러가 나는지 => 전부 실패해야함', function () {
                TEST_HELPER.makeTestByList(
                    TEST_HELPER.removeItem(
                        TEST_HELPER.TYPE_LIST.ALL,
            ...
            describe('키가 중복 될떄 에러가 나는지 => 실패해야함', function () {
        ...
        describe('Test - type', function () {
            describe('정의가능한 타입 입력 => 전부 성공해야함', function () {
                var TEST_LIST = []
            ...
            describe('정의할수없는 타입을 입력함 => 실패해야함', function () {
        ...
        describe('Test - option', function () {
            ...
            describe('순수 Object or nullish 가 아닐경우 테스트 => 전부 실패해야함', function () {
                TEST_HELPER.makeTestByList(
                    TEST_HELPER.removeItem(
                        TEST_HELPER.TYPE_LIST.ALL,
                        TEST_HELPER.TYPE_LIST.OBJECT_NULLISH
            ...
            describe('Test - option의 세부항목의 기본값 테스트', function () {
                it('option 미설정시 option.nullishAble 기본값은 true', function () {
