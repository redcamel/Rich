Rich.init(
    ...
    describe('Test - INT', function () {
        describe('Test - 허용범위 테스트', function () {
            [-2, -1, 0, 1, 2].forEach(function (v) {
                it('입력값 : ' + v, function () {
                    ...
                    Rich.defineProperty(target.prototype, 'keyName_test', Rich.defineProperty.INT)
        ...
        describe('Test - 허용범위 외 테스트', function () {
            [-1.1, 1.1, NaN, null, undefined, true, false, '문자열', {}, function () {
            }].forEach(function (v) {
                it('입력값 : ' + v, function () {
                    var target = function Test() {
                    }
        ...
        describe('Test - option 테스트', function () {
            describe('Test - option.value 테스트', function () {
                ...
                [-1, 0, 1].forEach(function (v) {
                    it('{ value : ' + v + ' } 초기값이 정수만 허용하는지', function () {
                        var target = function Test() {
                        }
                        Rich.defineProperty(
                            target.prototype,
